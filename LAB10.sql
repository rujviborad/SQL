...
SELECT CEILING(25.2) AS INT , CEILING(25.7) AS INT , CEILING(-25.2) AS INT

--4. Find largest integer value that is smaller than or equal to 25.2, 25.7 and -25.2.
SELECT FLOOR(25.2) AS INT , FLOOR(25.7) AS INT , FLOOR(-25.2) AS INT

--5. Find out remainder of 5 divided 2 and 5 divided by 3.
SELECT 5%2 AS REMAINDER , 5%3 AS REMAINDER

--6. Find out value of 3 raised to 2nd power and 4 raised 3rd power.
SELECT POWER(3,2) AS P1 , POWER(4,3) AS P2

--7. Find out the square root of 25, 30 and 50.
SELECT SQRT(25) AS SQRT, SQRT(30) AS SQRT , SQRT(50) AS SQRT
...
SELECT ROUND(157.732 , 2) AS ROUND , ROUND(157.732 , 0) AS ROUND , ROUND(157.732 , -1) AS ROUND 
...
SELECT LOWER('Rujvi') AS LOWER, UPPER('Rujvi') AS UPPER

--3. Display first three characters of your name.
SELECT LEFT('RUJVI' , 3)

--4. Display 3rd to 10th character of your name.
SELECT SUBSTRING('RUJVI' , 3 , 8)
