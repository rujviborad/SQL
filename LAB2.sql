...
VALUES (101,'MEET','MAVDI',10000,'2025-03-01'),
		...
		VALUES (101,'HETVI','RAJKOT',7.40,'COMPUTER'),
			   ...
			   EID INT,FIRSTNAME VARCHAR(50),LASTNAME  VARCHAR(50),DEPARTMENT  VARCHAR(50),
			   SALARY    DECIMAL(7,2), CITY VARCHAR(50),GENDER VARCHAR(10),JOININGYEAR   INT);
